...
interface MealFiltersProps {
  onFilterChange: (filters: MealFilterParams) => void;
  initialFilters?: MealFilterParams;
}
...
export default function MealFilters({
  ...
  const handleChange = (key: keyof MealFilterParams, value: string) => {
  ...
  const handleClearFilters = () => {
    const clearedFilters: MealFilterParams = {
      search: '',
      categoryId: '',
      dietaryInfo: '',
      minPrice: '',
